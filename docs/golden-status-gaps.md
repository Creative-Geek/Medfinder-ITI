...
| 2        | **A. Search**                           | Medium  | Port from byteStore. Wires navbar to shop filters.                        |
...
| 13       | **N. Page Transition Animation (fade)** | Medium  | Add fade-in/fade-out animation to page transitions (byteStore reference). |
